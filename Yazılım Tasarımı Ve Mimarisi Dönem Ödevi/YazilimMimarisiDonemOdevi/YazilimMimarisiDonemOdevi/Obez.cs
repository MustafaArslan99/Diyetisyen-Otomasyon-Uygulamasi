...
namespace YazilimMimarisiDonemOdevi
{
    public class Obez:HastalikCesidiAbstraction
    {
        ...
        public override void Hastalik()
        {
            ...
            if(deger == 0)
            {                
                komut.CommandText = "insert into Hasta(HastaAdi,HastaSoyadi,HastaTCNO,Hastalik,DiyetYontemi,Kahvalti,OgleYemegi,AksamYemegi) values('" + base.KisiAd + "','" + base.KisiSoyad + "','" + base.KisiTCNO + "','Obez','" + diyet.Diyet() + "','" + diyet.Kahvalti() + "','" + diyet.OgleYemegi() + "','" + diyet.AksamYemegi() + "')";
            ...
            {
                komut.CommandText = "update Hasta set Hastalik='Obez',DiyetYontemi='" +diyet.Diyet() + "',Kahvalti='" + diyet.Kahvalti() +"',OgleYemegi='" + diyet.OgleYemegi() +"',AksamYemegi='" + diyet.AksamYemegi() +"' where HastaTCNO="+ base.KisiTCNO +"";
